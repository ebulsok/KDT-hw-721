...
promotionToggleBtn.addEventListener("click", function() {
    if(promotionEl.classList.contains("hide")) promotionEl.classList.remove("hide");
    else promotionEl.classList.add("hide");
    
    if(promotionToggleBtn.style.transform === "rotate(180deg)") promotionToggleBtn.style.transform = "rotate(0deg)";
...
window.addEventListener("scroll", function() {
    ...
    else if(scrollYPos < 500 && peru.classList.contains("animate")) peru.classList.remove("animate");

    if(scrollYPos > 900) indonesia.classList.add("animate");
    else if(scrollYPos < 900 && indonesia.classList.contains("animate")) indonesia.classList.remove("animate");

    if(scrollYPos > 1600) favorite.classList.add("animate");
    else if(scrollYPos < 1600 && favorite.classList.contains("animate")) favorite.classList.remove("animate");

    if(scrollYPos > 2200) magazine.classList.add("animate");
    else if(scrollYPos < 2200 && magazine.classList.contains("animate")) magazine.classList.remove("animate");

    if(scrollYPos > 2600) store.classList.add("animate");
    else if(scrollYPos < 2600 && store.classList.contains("animate")) store.classList.remove("animate");
})
